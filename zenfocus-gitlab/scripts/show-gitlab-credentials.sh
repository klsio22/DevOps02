...
echo ""
echo "Observacao: a senha inicial do root expira e o arquivo /etc/gitlab/initial_root_password"
echo "normalmente deixa de existir depois de 24h. Salve a senha assim que ela aparecer."
echo ""
echo "========================================"
